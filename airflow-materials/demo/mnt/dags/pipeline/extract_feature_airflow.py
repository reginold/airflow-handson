...
# @click.option('--flag')
def extract_features(in_train_csv, in_test_csv, out_dir):
    # create directory
...
if __name__ == "__main__":
    ...
    extract_features(
        in_train_csv=config["extract_feature"]["in_train_csv"],
        in_test_csv=config["extract_feature"]["in_test_csv"],
        out_dir=config["extract_feature"]["out_dir"],
    )
