...
def train_model(in_train_features_csv, in_train_target_csv, out_dir):
    # create directory
    ...
    log = logging.getLogger("Train the model")
...
if __name__ == "__main__":
    ...
    train_model(
        in_train_features_csv=config["train_model"]["in_train_features_csv"],
        in_train_target_csv=config["train_model"]["in_train_target_csv"],
        out_dir=config["train_model"]["out_dir"],
    )
